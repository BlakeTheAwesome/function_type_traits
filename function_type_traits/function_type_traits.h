...
namespace function_type_traits_detail
{
...
struct function_type_traits : function_type_traits_detail::function_type_traits_impl<std::remove_cvref_t<std::remove_pointer_t<FnType>>> {
	using identity = function_type_traits_detail::function_type_traits_impl<std::remove_cvref_t<std::remove_pointer_t<FnType>>>;
};


template <auto FnPtr>
struct function_traits : function_type_traits<decltype(FnPtr)>
{
};
